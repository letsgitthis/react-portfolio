          ...
          <div class="card">
            <div class="card-image">
              ...
              >
                <img
                  class="card-video"
                  src="../../images/Space Portal _ Main.gif"
          ...
          <div class="card">
            <div class="card-image">
              ...
              >
                <img
                  class="card-video"
                  src="../images/Screenshot from 2020-08-10 17-54-50.png"
                  alt="project-two-img"
                />
              </a>
              <span class="card-title"></span>
            ...
            <div class="card-content">
              ...
              <p>
                ...
                updated and deleted. (Please note that we are currently updating
                the main repo, so this specific field may not be completed. Link
                will only take you to Github until Heroku launch.)
              </p>
            </div>
            <div class="card-action">
              <a 
          ...
          <div class="card">
            <div class="card-image">
              ...
              >
                <img
                  class="card-video"
                  src="../images/Rock Paper Scissors.gif"
        ...
        <div class="col s12 m6">
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p>
                A site that displays saved content in designated time cards for
                the work day. The current hour will be displayed as red. Passed
                hours will display as gray. Future hours will display green.
                Time and color update should function live without refresh.
              </p>
            </div>
            <div class="card-action">
              <a
        ...
        <div class="col s12 m6">
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p>
                A site that displays the weather forecast for cities you search
                for and saves the city in a list where you can click to search
                again without having to use the search bar each time.
              </p>
            </div>
            <div class="card-action">
              <a
